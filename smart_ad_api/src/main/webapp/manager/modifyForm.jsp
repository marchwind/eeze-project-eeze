...
<body>
<form id="form" action="${pageContext.request.contextPath}/pmc/manager/updatePassword" method="post">
 ...
 <table> 
   ...
   <td><input type="text" id="sendPath" name="managerPassword" size="30"  value="pWd"></td>
  </tr>
