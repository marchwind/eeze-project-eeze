...
<body>
<form id="form" action="${pageContext.request.contextPath}/pmc/manager/subscribe" method="post">
 ...
 <table> 
   ...
   <td><input type="text" id="sendPath" name="managerMode" size="30"  value="Y"></td>
      ...
      <tr>
   <td>managerId</td>
   <td><input type="text" id="sendPath" name="managerId" size="30"  value="eoclehdrla"></td>
  </tr>
      <tr>
