...
<body>
<form id="form" action="${pageContext.request.contextPath}/pmc/user/reserve/list" method="post">
 ...
 <table> 
   ...
   <td><input type="text" id="sendPath" name="unitPerPage" size="25"  value="10"></td>
      ...
      <tr>
   <td>userNo</td>
   <td><input type="text" id="sendPath" name="userNo" size="US0000000211"  value="US0000000211"></td>
  </tr>
